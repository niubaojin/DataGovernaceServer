...
create index INDEX_SPB_DI on DAC_STORAGE_PROVIDER_BILL (DATA_ID) local;
create index INDEX_SPB_PBN on DAC_STORAGE_PROVIDER_BILL (PROVIDER_BILL_NO) local;
alter table DAC_STORAGE_PROVIDER_BILL enable row movement;
...
(
    ACCEPTOR_BILL_NO   VARCHAR2(100),
    ACCEPTOR_NO        VARCHAR2(50),
    RESOURCE_ID        VARCHAR2(50),
    DATA_COUNT         NUMBER,
    DATA_FINGERPRINT   VARCHAR2(50),
    FINGERPRINT_TYPE   VARCHAR2(20),
    ...
    END_NO             VARCHAR2(20),
    SOURCE_LOCATION    VARCHAR2(255),
    CHECK_METHOD       NUMBER default 2,
    LAST_FAIL_BILL     VARCHAR2(50),
    DATA_ARRIVE_TIME   DATE,
    DATA_CHECK_TIME    DATE,
    DATA_SOURCE_NAME   VARCHAR2(255),
    DATA_ID            VARCHAR2(255),
    BILL_STATE         NUMBER default 0,
    BILL_TYPE          NUMBER,
    DATA_ADMINISTRATOR VARCHAR2(50),
    ADMINISTRATOR_TEL  VARCHAR2(20),
    DATA_SOURCE_TYPE   NUMBER,
...
(partition part_002 VALUES less than (to_date( '2021-11-26 00:00:00', 'yyyy-mm-dd HH24:mi:ss' )));
create index INDEX_SAAB_ABN on DAC_STANDARD_ACCEPTOR_BILL (ACCEPTOR_BILL_NO) local;
create index INDEX_SAAB_DI on DAC_STANDARD_ACCEPTOR_BILL (DATA_ID) local;
alter table DAC_STANDARD_ACCEPTOR_BILL enable row movement;
...
(partition part_002 VALUES less than (to_date( '2021-11-26 00:00:00', 'yyyy-mm-dd HH24:mi:ss' )));
create index INDEX_SSPB_DI on DAC_STANDARD_PROVIDER_BILL (DATA_ID) local;
create index INDEX_SSPB_PBN on DAC_STANDARD_PROVIDER_BILL (PROVIDER_BILL_NO) local;
alter table DAC_STANDARD_PROVIDER_BILL enable row movement;
...
(partition part_002 VALUES less than (to_date( '2021-11-26 00:00:00', 'yyyy-mm-dd HH24:mi:ss' )));
create index INDEX_SSAB_ABN on DAC_STORAGE_ACCEPTOR_BILL (ACCEPTOR_BILL_NO) local;
create index INDEX_SSAB_DI on DAC_STORAGE_ACCEPTOR_BILL (DATA_ID) local;
alter table DAC_STORAGE_ACCEPTOR_BILL enable row movement;
