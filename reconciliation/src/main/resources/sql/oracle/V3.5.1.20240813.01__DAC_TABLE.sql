...
(
    ...
    PARTITION BY RANGE (DATA_SEND_TIME) INTERVAL(NUMTODSINTERVAL(1,'hour'))
SUBPARTITION BY LIST(BILL_STATE)
SUBPARTITION TEMPLATE
(
SUBPARTITION P0 VALUES('0','1'),
SUBPARTITION P1 VALUES('2'),
SUBPARTITION P2 VALUES('3')
)
...
PARTITION BY RANGE (DATA_ARRIVE_TIME) INTERVAL(NUMTODSINTERVAL(1,'hour'))
SUBPARTITION BY LIST(BILL_STATE)
SUBPARTITION TEMPLATE
(
SUBPARTITION P0 VALUES('0','1'),
...
partition by range (CREATE_TIME) INTERVAL(numtoyminterval(1, 'year')) (partition part_002 VALUES less than(to_date('2021-11-26 00:00:00','yyyy-mm-dd HH24:mi:ss')));
...
create bitmap index DAC_DAB_IDX2 on DAC_ACCEPTOR_BILL (SJZYBSF);
...
PARTITION BY RANGE (DATA_TIME) INTERVAL(NUMTOYMINTERVAL(1,'month'))(partition part_001 VALUES less than(to_date('2021-11-26','yyyy-mm-dd')));
...
PARTITION BY RANGE(CHECK_TIME) INTERVAL(numtoyminterval(1,'month'))
