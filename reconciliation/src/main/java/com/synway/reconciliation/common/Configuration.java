...
import com.synway.common.spi.ErrorCode;
import com.synway.common.util.StrUtil;
...
public class Configuration {
    ...
    public static Configuration from(String json) {
        ...
        try {
            ...
            throw SystemException.asSystemException(CommonErrorCode.CONFIG_ERROR,
                    e);
        }
    ...
    public static Configuration from(File file) {
        try {
            ...
            throw SystemException.asSystemException(
    ...
    public String getNecessaryValue(String key, ErrorCode errorCode) {
        ...
        if (StringUtils.isBlank(value)) {
            throw SystemException.asSystemException(errorCode,
    ...
    private void setObject(final String path, final Object object) {
        ...
        throw SystemException.asSystemException(CommonErrorCode.RUNTIME_ERROR,
