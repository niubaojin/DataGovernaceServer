...
import com.synway.reconciliation.conditional.PostgreSqlCondition;
...
public class PostGreSqlDataSourceConfig {
    ...
    public PlatformTransactionManager pgTransactionManager(@Qualifier("dataSource") DruidDataSource datasource){
