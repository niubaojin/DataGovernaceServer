...
//    public static final String DATA_LABELS_CLASSIFY = "dataLabelClassify";
     ...
     * 资源登记地址
     */
    public static final String RESOURCEREGISTER_BASEURL = "http://resourceregister";
     ...
     * 数据标准地址
     */
    public static final String DATASTANDARDMANGER_BASEURL = "http://datastandardmanager";
