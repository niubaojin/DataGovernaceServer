...
public final class MD5 {
	 ...
	 * */
	public static String MD5_16bit(String readyEncryptStr) throws NoSuchAlgorithmException{
	 ...
	 * @throws NoSuchAlgorithmException 
	 * */
	public static String MD5_32bit2(String readyEncryptStr) throws NoSuchAlgorithmException{
		if(readyEncryptStr != null){
			//The cipher text converted to hexadecimal string
			StringBuilder su = new StringBuilder();
			//Get MD5 digest algorithm's MessageDigest's instance.
	 ...
	 * */
	public static String MD5_64bit(String readyEncryptStr) throws NoSuchAlgorithmException, UnsupportedEncodingException{
		MessageDigest md = MessageDigest.getInstance(ALGORITHM_MD5);
