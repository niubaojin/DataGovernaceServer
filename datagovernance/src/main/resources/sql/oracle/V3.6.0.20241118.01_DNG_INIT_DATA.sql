...
--将 approval_info 的数据转移到  dgn_approval 中,并淘汰 approval_info
...
select APPROVAL_ID, MODULE_NAME, OPERATION_NAME, APPLICATION_INFO, CALLBACK_DATA, CALLBACK_URL, CREATE_TIME, STATUS, MODULE_ID, OPERATOR_ID, TASK_ID, VIEW_URL, PROCESSINSTANCEID, EXECUTE_RESULT from approval_info;
