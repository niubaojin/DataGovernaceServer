...
(
    ...
    ALARM_MODULE  VARCHAR(100),
    ALARM_TIME    DATE,
    ALARM_FLAG    VARCHAR(100),
...
(
    DG_ID            VARCHAR(100),
    DG_LINK          VARCHAR(100),
    DG_DATANAME      VARCHAR(100),
    DG_TABLENAME     VARCHAR(100),
    DG_TABLEID       VARCHAR(100),
    DG_MSG           VARCHAR(1000),
    DG_UPDATETIME    DATE,
    DG_SPONSOR       VARCHAR(100),
    DG_SPONSOR_TIME  DATE,
    DG_MANAGER       VARCHAR(100),
...
(
    ...
    PUSH_HOUR          VARCHAR(10),
    INSERTTIME         DATE default CURRENT_DATE,
    DATA_TYPE          VARCHAR(10) default 1
);
...
(
    ...
    TABLEID      VARCHAR(100),
    TABLENAME_CH VARCHAR(100),
    DATA_TYPE    VARCHAR(100),
    OPERATOR_NET VARCHAR(100),
...
create table DO_OPERATOR_LOG(
    NUM_ID    NUMERIC,
    OPERATE_TIME      VARCHAR(100),
    TERMINAL_ID VARCHAR(100),
    OPERATE_TYPE    NUMERIC,
    OPERATE_RESULT VARCHAR(100),
    ERROR_CODE  VARCHAR(100),
    OPERATE_NAME     VARCHAR(100),
    OPERATE_CONDITION     VARCHAR(4000),
    DISPLAY     VARCHAR(100),
    DATA_LEVEL  NUMERIC,
    CREATE_TIME   DATE,
    UPDATE_TIME   DATE,
