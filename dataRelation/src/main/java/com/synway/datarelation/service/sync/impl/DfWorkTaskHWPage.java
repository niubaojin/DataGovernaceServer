 ...
 *
 */
public class DfWorkTaskHWPage implements DfWorkTaskPage {

    private static final Logger logger = LoggerFactory.getLogger(DfWorkTaskHWPage.class);
    private TaskPageQueryDao taskPageQueryDao;
    private AsyManager asyManager;

    public DfWorkTaskHWPage(){
