...
//
///**
// * @ClassName KingbaseDataSourceConfig
// * @description 金仓数据库的连接信息
// * @author wangdongwei
// * @date 2020/8/19 17:33
// */
//@Configuration
//@Conditional(KingbaseConditional.class)
//public class KingbaseDataSourceConfig {
//    private static Logger logger = LoggerFactory.getLogger(KingbaseDataSourceConfig.class);
...
//        logger.info("数据库类型为金仓数据库 url为："+env.getProperty("database.url")+" userName:"+env.getProperty("database.name")
