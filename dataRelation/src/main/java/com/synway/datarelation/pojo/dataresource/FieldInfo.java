...
public class FieldInfo {
    ...
    public String toString() {
        return "FieldInfo{" +
                ...
                ", originalDxnry='" + originalDxnry + '\'' +
                ", determinerId='" + determinerId + '\'' +
                ", determiner='" + determiner + '\'' +
                ", synFieldId='" + synFieldId + '\'' +
                ", synFieldName='" + synFieldName + '\'' +
                ", synFieldType='" + synFieldType + '\'' +
                ", synFieldLength='" + synFieldLength + '\'' +
                ", elementId='" + elementId + '\'' +
                ", elementName='" + elementName + '\'' +
                ", entityId='" + entityId + '\'' +
                ", entityName='" + entityName + '\'' +
                ", dataDxnryId='" + dataDxnryId + '\'' +
                ", dataDxnry='" + dataDxnry + '\'' +
                ", SCORE=" + SCORE +
                ", comments='" + comments + '\'' +
                '}';
