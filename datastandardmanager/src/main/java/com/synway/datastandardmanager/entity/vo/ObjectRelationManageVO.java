...
@AllArgsConstructor
@NoArgsConstructor
public class ObjectRelationManageVO implements Serializable {
    ...
    //原始汇聚层数据集id
    private Integer originalObjectId;
    //原始汇聚层数据名称
     ...
     */
    //标准层数据集id
    private Integer standardObjectId;
    //标准数据集数据名称
     ...
     * 数据项
     */
    private List<StandardizeObjectfieldRelEntity> objectFieldRelation;
