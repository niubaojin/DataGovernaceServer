...
public class ResourceTableData {
     ...
     * 接入信息的相关信息
     * json格式的key值
     * 接入服务方 ：  accessServiceProvider  接入方式   :   accessMode
     * 接入服务人 :  accessServicePersion  接入服务人联系方式 : accessServiceProviderPhone 接入说明   :   accessInstructions
     */
    private String accessServiceInformation="";


    public String getAccessServiceInformation() {
        return accessServiceInformation;
    }

    public void setAccessServiceInformation(String accessServiceInformation) {
        this.accessServiceInformation = accessServiceInformation;
    }
