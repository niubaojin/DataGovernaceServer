 ...
 * @date 2020/9/7 19:57
 */
public class PublicDataInfo implements Serializable {
    // 标准数据项集编码(TABLEID)
     ...
     *  标签数据
     */
    private List<LabelManageData> labels;
    ...
    public String getSJZYLYLXVALUE() {
        return SJZYLYLXVALUE;
    }

    public void setSJZYLYLXVALUE(String SJZYLYLXVALUE) {
        this.SJZYLYLXVALUE = SJZYLYLXVALUE;
    }

    public String getSJZZYJFLVALLUE() {
        return SJZZYJFLVALLUE;
    }

    public void setSJZZYJFLVALLUE(String SJZZYJFLVALLUE) {
        this.SJZZYJFLVALLUE = SJZZYJFLVALLUE;
    }

    public String getSJZZEJFLVALUE() {
        return SJZZEJFLVALUE;
    }

    public void setSJZZEJFLVALUE(String SJZZEJFLVALUE) {
        this.SJZZEJFLVALUE = SJZZEJFLVALUE;
    }

    public List<LabelManageData> getLabels() {
        return labels;
    }

    public void setLabels(List<LabelManageData> labels) {
        this.labels = labels;
    }
