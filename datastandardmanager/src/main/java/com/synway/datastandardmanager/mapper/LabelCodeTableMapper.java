...
import com.synway.datastandardmanager.entity.pojo.DsmLabelCodeTableEntity;
import com.synway.datastandardmanager.entity.vo.SelectFieldVO;

import java.util.List;

public interface LabelCodeTableMapper extends BaseMapper<DsmLabelCodeTableEntity> {
