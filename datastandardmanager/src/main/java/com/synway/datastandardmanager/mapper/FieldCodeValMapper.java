...
public interface FieldCodeValMapper extends BaseMapper<FieldCodeValEntity> {
    ...
    List<ValueLabelVO> queryLabelValueByCodeId(@Param("codeId") String codeId);
    ...
    List<ValueLabelVO> getPrimaryClassifyData(@Param("mainClassify") String mainClassify, @Param("sjzzflCodeId") String sjzzflCodeId);

    /**
     * 获取二级分类信息
     */
    @AuthorControl(tableNames ={"classify_interface_all_date"},columnNames = {"sjxjbm"})
    List<ValueLabelVO> getSecondaryClassifyData(@Param("mainClassify") String mainClassify,
     ...
     */
    @AuthorControl(tableNames = {"classify_interface_all_date"},columnNames = {"sjxjbm"})
    List<ValueLabelVO> getThreeClassifyData(@Param("primaryClassifyCode") String primaryClassifyCode,
