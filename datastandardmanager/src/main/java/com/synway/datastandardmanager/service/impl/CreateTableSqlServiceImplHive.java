 ...
 */
@Slf4j
public class CreateTableSqlServiceImplHive implements CreateTableSqlService {
    ...
    public String getAddColumnSql(CreateTableInfoDTO data) {
        ...
        if (data.isCreatedTableIsPartition()) {
    ...
    public String addColumnByData(CreateTableInfoDTO data) {
        ...
        log.info(">>>>>>hive新增字段生成的sql语句为：" + sqlStr);
