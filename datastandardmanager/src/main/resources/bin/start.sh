...
# 程序名称
server_name="datastandardmanager"
# jar包名称
server_jar="datastandardmanager*.jar"
# 日志目录路径
...
JAVA_OPT="${JAVA_OPT} -XX:-OmitStackTraceInFastThrow --add-opens java.base/java.lang=ALL-UNNAMED"
