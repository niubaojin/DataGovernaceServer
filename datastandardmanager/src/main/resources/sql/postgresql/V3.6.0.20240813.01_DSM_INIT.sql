-- 标签分类信息
insert into LABEL_CODE_TABLE (LABEL_LEVEL, LABEL_NAME)
values (6, '标签六');
insert into LABEL_CODE_TABLE (LABEL_LEVEL, LABEL_NAME)
values (1, '标签一');
insert into LABEL_CODE_TABLE (LABEL_LEVEL, LABEL_NAME)
...
-- 插入平台类型数据
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10001', 'store_type', '1', 'ODPS', 'ODPS');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10002', 'store_type', '2', 'ADS', 'ADS');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10003', 'store_type', '4', 'HBase-HUAWEI', 'HBase-HUAWEI');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10004', 'store_type', '5', 'Hive-HUAWEI', 'Hive-HUAWEI');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10007', 'store_type', '7', 'ClickHouse', 'ClickHouse');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10008', 'store_type', '9', 'TRSHybase', 'TRSHybase');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10010', 'store_type', '10', 'Oracle', 'Oracle');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10011', 'store_type', '11', 'HBase-CDH', 'HBase-CDH');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10012', 'store_type', '12', 'Hive-CDH', 'Hive-CDH');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10014', 'store_type', '14', 'Kafka', 'Kafka');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10015', 'store_type', '15', 'RocketMq', 'RocketMq');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10016', 'store_type', '16', 'Redis', 'Redis');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10019', 'store_type', '19', 'FTP', 'FTP');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('3442123123', 'SYNLTEFIELD_STATUS', '01', '新建', '数据元页面中的状态-新建');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12312312', 'SYNLTEFIELD_STATUS', '05', '发布', '数据元页面中的状态-发布');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12331423423', 'field_type', '0', 'integer', '整数型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('5241331', 'field_type', '1', 'float', '浮点型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('124324352', 'field_type', '2', 'string', '字符串型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('134123234', 'field_type', '3', 'date', '日期型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12131312', 'field_type', '4', 'datetime', '日期时间型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12342423', 'field_type', '6', 'long', '长整型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2325423', 'field_type', '7', 'double', '双精度浮点型');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('11111', 'EXPRESSION_WORD', '名称', '名称', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12312', 'EXPRESSION_WORD', '描述', '描述', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12312', 'EXPRESSION_WORD', '金额', '金额', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('1231', 'EXPRESSION_WORD', '日期', '日期', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('123123', 'EXPRESSION_WORD', '日期时间', '日期时间', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('123123', 'EXPRESSION_WORD', '代码', '代码', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('123123', 'EXPRESSION_WORD', '号码', '号码', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('432142', 'EXPRESSION_WORD', '百分比', '百分比', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('234', 'EXPRESSION_WORD', '量', '量', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2542', 'EXPRESSION_WORD', '比率', '比率', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2423', 'EXPRESSION_WORD', '指示符', '指示符', '数据元页面中的表示词');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2185', 'ELEMENTOBJECT', '1', '人员', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2186', 'ELEMENTOBJECT', '2', '物', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2187', 'ELEMENTOBJECT', '3', '组织', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2188', 'ELEMENTOBJECT', '4', '地', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2189', 'ELEMENTOBJECT', '5', '事', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2190', 'ELEMENTOBJECT', '6', '时间', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('2191', 'ELEMENTOBJECT', '7', '信息', '数据元素中的关联主体');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('01', 'SECURITYLEVEL', '01', '第一级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('02', 'SECURITYLEVEL', '02', '第二级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('02', 'SECURITYLEVEL', '03', '第三级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('03', 'SECURITYLEVEL', '04', '第四级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('03', 'SECURITYLEVEL', '05', '第五级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('03', 'SECURITYLEVEL', '06', '第六级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('04', 'SECURITYLEVEL', '07', '第七级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('04', 'SECURITYLEVEL', '08', '第八级', '字段定义中的数据安全级别');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('12244333', 'CLICKHOUSE_FUNCTION', 'toDayOfYear', 'toDayOfYear', 'clickhouse建表时使用的函数名称');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('1231232', 'CLICKHOUSE_FUNCTION', 'toMonth', 'toMonth', 'clickhouse建表时使用的函数名称');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('123221', 'CLICKHOUSE_FUNCTION', 'toYYYYMM', 'toYYYYMM', 'clickhouse建表时使用的函数名称');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('1236126312', 'CLICKHOUSE_FUNCTION', 'toYYYYMMDD', 'toYYYYMMDD', 'clickhouse建表时使用的函数名称');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('123123221', 'CLICKHOUSE_FUNCTION', 'toYear', 'toYear', 'clickhouse建表时使用的函数名称');
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('mfdso', 'fdsafd', 'fsadgds', 'fdasg', null);
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('1', '1', '1', '1', null);
insert into all_code_data (ID, CODE_ID, CODE_VALUE, CODE_TEXT, MEMO) values ('10001', 'store_type', '7', 'Clickhouse', 'Clickhouse');
commit ;

insert into DD_BDDM (DMZD, DMZDZWM, DM, DMMC)
...
commit ;
insert into OBJECT_MANAGE_STANDARD (ID, VALUE, TYPE, REMARKS, DELETED, PARID, TEXT)
